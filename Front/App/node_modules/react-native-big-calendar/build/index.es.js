...
function useCalendarTouchableOpacityProps(_a) {
    ...
    var touchableOpacityProps = {
        ...
        style: __spreadArray(__spreadArray([eventCellCss.style], injectedStyles), [getEventStyle(plainJsEvent)]),
        onPress: _onPress,
...
function _CalendarEventForMonthView(_a) {
    ...
    return (React.createElement(TouchableOpacity, __assign({}, touchableOpacityProps),
        React.createElement(Text, { style: [{ color: theme.palette.primary.contrastText }, theme.typography.xs, u['truncate']], numberOfLines: 1 }, event.title)));
}
    ...
    return (React.createElement(View, __assign({ style: [
        ...
        date &&
            events
                ...
                .reduce(function (elements, event, index, events) { return __spreadArray(__spreadArray([], elements), [
                index > maxVisibleEventCount ? null : index === maxVisibleEventCount ? (React.createElement(Text, { key: index, style: { fontSize: 11, marginTop: 2, fontWeight: 'bold' } },
                    ...
                    " More")) : (React.createElement(CalendarEventForMonthView, { key: index, event: event, eventCellStyle: eventCellStyle, onPressEvent: onPressEvent, renderEvent: renderEvent })),
            ]); }, []))); }))); })));
}
        ...
        dateRange.map(function (date) {
            ...
            return (React.createElement(TouchableOpacity, { style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPress(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() },
                ...
                React.createElement(View, { style: [
                    ...
                    return (React.createElement(View, { style: [eventCellCss.style, primaryBg], key: "" + event.start + event.title },
                        React.createElement(Text, { style: {
