...
function _CalendarEventForMonthView(_a) {
    ...
    return (React__namespace.createElement(reactNative.TouchableOpacity, __assign({}, touchableOpacityProps),
        React__namespace.createElement(reactNative.Text, { style: [{ color: theme.palette.primary.contrastText }, theme.typography.xs, u['truncate']], numberOfLines: 1 }, event.title)));
}
        ...
        date &&
            events
                ...
                index > maxVisibleEventCount ? null : index === maxVisibleEventCount ? (React__namespace.createElement(reactNative.Text, { key: index, style: { fontSize: 11, marginTop: 2, fontWeight: 'bold' } },
                    ...
                    " More")) : (React__namespace.createElement(CalendarEventForMonthView, { key: index, event: event, eventCellStyle: eventCellStyle, onPressEvent: onPressEvent, renderEvent: renderEvent })),
            ]); }, []))); }))); })));
}
        ...
        dateRange.map(function (date) {
            ...
            return (React__namespace.createElement(reactNative.TouchableOpacity, { style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPress(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() },
                ...
                React__namespace.createElement(reactNative.View, { style: [
                    ...
                    return (React__namespace.createElement(reactNative.View, { style: [eventCellCss.style, primaryBg], key: "" + event.start + event.title },
                        React__namespace.createElement(reactNative.Text, { style: {
